python main.py -data nipsB_offline -batch_size 128 -plot_title 'paper_0201_new_2f' \
-max_epoch 20 -lr 1e-3 -opt Adam -test_batch_size 5000 -model deepgbm -task binary -l2_reg 1e-6 \
