python main.py -data nipsD_offline -batch_size 128 -plot_title 'paper_0203' \
-max_epoch 40 -lr 1e-3 -opt Adam -test_batch_size 5000 -model gbdt2nn -task binary -l2_reg 1e-6 \
